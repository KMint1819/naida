...
#define NAIDA_TRACE(...) ::naida::get_logger()->trace(__VA_ARGS__)
#else
#define NAIDA_TRACE(...)
#endif
#if NAIDA_LOG_LEVEL <= NAIDA_LOG_LEVEL_INFO
#define NAIDA_INFO(...) ::naida::get_logger()->info(__VA_ARGS__)
#else
#define NAIDA_INFO(...)
#endif
#if NAIDA_LOG_LEVEL <= NAIDA_LOG_LEVEL_WARN
#define NAIDA_WARN(...) ::naida::get_logger()->warn(__VA_ARGS__)
#else
#define NAIDA_WARN(...)
#endif
#if NAIDA_LOG_LEVEL <= NAIDA_LOG_LEVEL_ERROR
#define NAIDA_ERROR(...) ::naida::get_logger()->error(__VA_ARGS__)
#else
#define NAIDA_ERROR(...)
#endif
